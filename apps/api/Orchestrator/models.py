...
from api.WineCellarAgent.models import CriticalityLevel
...
class RecommendationSearchPlan(BaseModel):
    ...
    should_call_market_analysis: bool = Field(..., description="Whether to call market analysis for this item")
